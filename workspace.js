...
cprequire_test(["inline:com-chilipeppr-workspace-grant1"], function(ws) {
    ...
    $('title').html("grant1 Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-grant1", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-grant1", // Make the id the same as the cpdefine id
        name: "Workspace / grant1", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace grant1.`,
